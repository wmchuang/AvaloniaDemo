...
namespace CalendarDemo.Calendar
{
    ...
    [TemplatePart(ElementCalendar, typeof(Avalonia.Controls.Calendar))]
    ...
    public partial class CalendarDatePicker : TemplatedControl
    {
        ...
        /// <see cref="T:Calendar" /> is closed.
        /// </summary>
        public event EventHandler? CalendarClosed;

        /// <summary>
        /// Occurs when the drop-down
        /// <see cref="T:Calendar" /> is opened.
        /// </summary>
        public event EventHandler? CalendarOpened;

        /// <summary>
        /// Occurs when <see cref="P:DatePicker.Text" />
        ...
        {
            SetCurrentValue(CalendarDatePicker.FirstDayOfWeekProperty, DateTimeHelper.GetCurrentDateFormat().FirstDayOfWeek);
            _defaultText = string.Empty;
            SetCurrentValue(CalendarDatePicker.DisplayDateProperty, DateTime.Today);
        }
        ...
        protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
        {
            ...
            if (change.Property == CalendarDatePicker.CustomDateFormatStringProperty)
            {
            ...
            // IsDropDownOpen
            else if (change.Property == CalendarDatePicker.IsDropDownOpenProperty)
            {
            ...
            // SelectedDate
            else if (change.Property == CalendarDatePicker.SelectedDateProperty)
            {
                ...
                if (SelectedDate != null)
                {
                    ...
                    Avalonia.Threading.Dispatcher.UIThread.InvokeAsync(() =>
                    {
                        ...
                        SetCurrentValue(CalendarDatePicker.TextProperty, DateTimeToString(day));
                    ...
                    {
                        SetCurrentValue(CalendarDatePicker.DisplayDateProperty, day);
                    }
            ...
            // SelectedDateFormat
            else if (change.Property == CalendarDatePicker.SelectedDateFormatProperty)
            {
                OnDateFormatChanged();
            }
            // Text
            else if (change.Property == CalendarDatePicker.TextProperty)
            {
                ...
                if (!_suspendTextChangeHandler)
                {
                    ...
                    else
                    {
                        ...
                        {
                            _settingSelectedDate = true;
                            SetCurrentValue(CalendarDatePicker.SelectedDateProperty, null);
                            _settingSelectedDate = false;
                        }
                    }
                }
        ...
        {
            if (property == CalendarDatePicker.SelectedDateProperty)
            {
        ...
        protected override void OnPointerWheelChanged(PointerWheelEventArgs e)
        {
            ...
            if (!e.Handled && SelectedDate.HasValue && _calendar != null)
            {
                ...
                {
                    SetCurrentValue(CalendarDatePicker.SelectedDateProperty, newDate);
                    e.Handled = true;
                }
            }
        }
        ...
        private void OnDateFormatChanged()
        {
            if (_textBox != null)
            {
                if (SelectedDate.HasValue)
                {
                    SetCurrentValue(CalendarDatePicker.TextProperty, DateTimeToString(SelectedDate.Value));
                }
                ...
                else
                {
                    ...
                    if (date != null)
                    {
                        ...
                        SetCurrentValue(CalendarDatePicker.TextProperty, s);
                    }
                }
            }
        }
        ...
        {
            Focus();
            SetCurrentValue(CalendarDatePicker.IsDropDownOpenProperty, false);
        }
        ...
        private void Calendar_DisplayDateChanged(object? sender, CalendarDateChangedEventArgs e)
        {
            ...
            {
                SetValue(CalendarDatePicker.DisplayDateProperty, (DateTime) e.AddedDate!);
            }
        }
        ...
        private void Calendar_SelectedDatesChanged(object? sender, SelectionChangedEventArgs e)
        {
            ...
            {
                SetCurrentValue(CalendarDatePicker.SelectedDateProperty, (DateTime?)e.AddedItems[0]);
            }
            else
            {
        ...
        {
            if (!e.Handled
                && sender is Avalonia.Controls.Calendar { DisplayMode: Avalonia.Controls.CalendarMode.Month }
                && (e.Key == Key.Enter || e.Key == Key.Space || e.Key == Key.Escape))
            {
                ...
                if (e.Key == Key.Escape)
                {
                    SetCurrentValue(CalendarDatePicker.SelectedDateProperty, _onOpenSelectedDate);
                }
            }
        }
        ...
        private void TextBox_TextChanged()
        {
            if (_textBox != null)
            {
                ...
                SetCurrentValue(CalendarDatePicker.TextProperty, _textBox.Text);
        ...
        private void PopUp_Closed(object? sender, EventArgs e)
        {
            ...
            if(!_isPopupClosing)
            {
                ...
                Avalonia.Threading.Dispatcher.UIThread.InvokeAsync(() => _isPopupClosing = false);
            }
        }

        /// <summary>
        /// Toggles the <see cref="CalendarDatePicker.IsDropDownOpen"/> property to open/close the calendar popup.
        ...
        private void TogglePopUp()
        {
            ...
            {
                SetSelectedDate();
                SetCurrentValue(CalendarDatePicker.IsDropDownOpenProperty, true);
                _calendar!.Focus();
            }
        }
        ...
        private void SetSelectedDate()
        {
            if (_textBox != null)
            {
                if (!string.IsNullOrEmpty(_textBox.Text))
                {
                    ...
                    if (SelectedDate != d)
                    {
                        SetCurrentValue(CalendarDatePicker.SelectedDateProperty, d);
                    }
                }
                else
                {
        ...
        private DateTime? SetTextBoxValue(string s)
        {
            ...
            {
                SetValue(CalendarDatePicker.TextProperty, s);
                return SelectedDate;
            }
            else
            {
                ...
                else
                {
                    ...
                    if (SelectedDate != null)
                    {
                        ...
                        SetValue(CalendarDatePicker.TextProperty, newtext);
                        return SelectedDate;
                    }
                    else
                    {
        ...
        private void SetWaterMarkText()
        {
            if (_textBox != null)
            {
                ...
                {
                    DateTimeFormatInfo dtfi = DateTimeHelper.GetCurrentDateFormat();
                    SetCurrentValue(CalendarDatePicker.TextProperty, string.Empty);
                    _defaultText = string.Empty;
