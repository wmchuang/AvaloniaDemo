...
[PseudoClasses(":pressed", ":disabled", ":selected", ":inactive", ":today", ":blackout", ":dayfocused", ":mark")]
public sealed class MiniCalendarDayButton : Button
{
    /// <summary>
    ...
    /// <see cref="T:CalendarDemo.Calendar.CalendarDayButton" />
    /// class.
    /// </summary>
    public MiniCalendarDayButton()
        : base()
    {
        //Focusable = false;
